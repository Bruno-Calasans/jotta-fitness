...
import AdhesionLogForm from "./AdhesionLogForm";
import { useLogStore } from "@/store/logStore";
import isDateEqual from "@/utils/isDateEquals";

export default function CreateAdhesionLogDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Registrar Adesão</DialogTitle>
        </DialogHeader>
        <AdhesionLogForm onSubmit={submitFormHandler} />
      </DialogContent>
    </Dialog>
  );
}
